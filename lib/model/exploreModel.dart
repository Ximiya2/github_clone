...
class Payload {
  ...
  factory Payload.fromJson(Map<String, dynamic> json) => Payload(
    ...
    release: json["release"] == null ? null : Release.fromJson(json["release"]),
...
class Release {
  Release({
    ...
    required this.isShortDescriptionHtmlTruncated,
  });
  ...
  factory Release.fromJson(Map<String, dynamic> json) => Release(
    ...
    body: json["body"],
    shortDescriptionHtml: json["short_description_html"],
    isShortDescriptionHtmlTruncated: json["is_short_description_html_truncated"],
  );
